export const rangeData = [
  {
    id: "PH1",
    title: "pH of the substratum min",
    items: [
      {
        value: '1',
  ...
  {
    id: "ALT1",
    title: "Altitudinal distribution min",
    items: [
      {
        value: '1',
  ...
  {
    id: "ALT2",
    title: "Altitudinal distribution max",
    items: [
      {
        value: '1',
        text: "1: eu-Mediterranean belt (potential vegetation: evergreen Quercus ilex forest)",
